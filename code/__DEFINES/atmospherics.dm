...
#define NO_GAS 0
#define OXYGEN_GAS 1
#define NITROGEN_GAS 2
#define CARBONDIOXIDE_GAS 4
#define STIMULUM_GAS 8
#define BZ_GAS 16
#define PLUOXIUM_GAS 32
#define NITRYL_GAS 64
#define NITROUSOXIDE_GAS 128
#define TRITIUM_GAS 256
#define WATERVAPOR_GAS 512
#define PLASMA_GAS 1024
#define HYPERNOBILIUM_GAS 2048
...
//EXCITED GROUPS
#define EXCITED_GROUP_BREAKDOWN_CYCLES				6		//number of FULL air controller ticks before an excited group breaks down (averages gas contents across turfs)
...
#define MINIMUM_TEMPERATURE_FOR_SUPERCONDUCTION		T20C+200
